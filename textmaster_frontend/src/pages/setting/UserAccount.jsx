        ...
        <div className="account_generalDiv">
          ...
          <div className="account_generalDivItems">
            <div className="account_generalDiv-item">
              ...
              <button className="account_general_colorThemeButton" onClick={toggleThemeOptions} aria-expanded={themeOpen}>
              ...
              {themeOpen && (
                <div className={`account_general_themeOuterDiv ${themeOpen ? "active" : ""} `} ref={themeRef} >
                  <div className="account_general_themeMainDiv">
                    <div className="account_general_themeMainDivItem" onClick={handleToggleTheme}>
                      <MdLightMode />
                      Light
                    </div>
                    <div className="account_general_themeMainDivItem" onClick={handleToggleTheme}>
